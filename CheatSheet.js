...
declare module 'url' {
  ...
  declare class URLSearchParams {
    ...
    forEach(
      fn: (value: string, name: string, searchParams: URLSearchParams) => void,
      thisArg?: any,
    ): void;
...
type zlib$syncFn = (buffer: string | Buffer, options?: zlib$options) => Buffer;
...
type repl$DefineCommandOptions = (
  ...args: Array<any>
) => void | {action: (...args: Array<any>) => void, help?: string};
